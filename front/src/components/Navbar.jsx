    ...
    <div className="w-full">
      ...
      <div className="w-full flex flex-row justify-between items-center h-16 ">
        <div className="flex flex-row items-center">
          ...
          <span className="font-serif"> VPPCOE Mini Project - Escrow Service - Group 38 </span>
        </div>
        <div className="flex">
          {walletAddress == "" ? (
            <>
      ...
      <div className="bg-[#111111] h-14 flex mt-5 justify-center items-center">
        <h1 className="font-serif text-[45px] text-gray-400"> Welcome to our Escrow service</h1>
      </div>
    </div>
  );
};
